...
export function PublicationCategoryForm(props: Props) {
  ...
  return (
    <form id="publication-category-form" className="max-w-3xl space-y-6" onSubmit={handleSubmit} noValidate>
      ...
      <DashboardFormActions formId="publication-category-form" align="end">
        <Link
          href={BACK_HREF}
